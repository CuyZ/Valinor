...
final class ClassImportedTypeAliasResolverTest extends UnitTestCase
{
    /**
    ...
    {
        $importedAliases = $this->classImportedTypeAliasResolver()->resolveImportedTypeAliases(new NativeClassType($className));
    ...
    public function test_class_with_invalid_alias_import_type_throws_exception(): void
    {
        ...
        $aliases = $this->classImportedTypeAliasResolver()->resolveImportedTypeAliases(new NativeClassType($class));
    ...
    private function classImportedTypeAliasResolver(): ClassImportedTypeAliasResolver
    {
        return new ClassImportedTypeAliasResolver(
