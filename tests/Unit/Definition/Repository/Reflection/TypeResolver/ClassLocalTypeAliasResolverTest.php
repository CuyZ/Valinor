...
final class ClassLocalTypeAliasResolverTest extends UnitTestCase
{
    /**
    ...
    {
        $aliases = $this->classLocalTypeAliasResolver()->resolveLocalTypeAliases(new NativeClassType($className));
        $aliases = array_map(
    ...
    {
        $aliases = $this->classLocalTypeAliasResolver()->resolveLocalTypeAliases(EnumType::native(SomeEnumWithLocalTypeAlias::class));

        self::assertInstanceOf(NonEmptyStringType::class, $aliases['SomeEnumAlias']);
    }

    private function classLocalTypeAliasResolver(): ClassLocalTypeAliasResolver
    {
        return new ClassLocalTypeAliasResolver(
