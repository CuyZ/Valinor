...
final class PropertyTypeResolverTest extends UnitTestCase
{
    ...
    {
        $type = $this->propertyTypeResolver()->resolveTypeFor($reflection);
    ...
    private function propertyTypeResolver(): PropertyTypeResolver
    {
