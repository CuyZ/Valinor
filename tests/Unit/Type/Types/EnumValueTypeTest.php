 ...
 * @requires PHP >= 8.1
 */
final class EnumValueTypeTest extends TestCase
{
    private EnumValueType $pureEnumType;

    private EnumValueType $backedStringEnumType;

    private EnumValueType $backedIntegerEnumType;

    protected function setUp(): void
    {
        parent::setUp();

        $this->pureEnumType = new EnumValueType(PureEnum::FOO);
        $this->backedStringEnumType = new EnumValueType(BackedStringEnum::FOO);
        $this->backedIntegerEnumType = new EnumValueType(BackedIntegerEnum::FOO);
    }
    ...
    public function test_does_not_accept_incorrect_values(): void
    {
        ...
        self::assertFalse($this->pureEnumType->accepts(PureEnum::BAR));
        ...
        self::assertFalse($this->backedStringEnumType->accepts(BackedStringEnum::BAR));
        ...
        self::assertFalse($this->backedIntegerEnumType->accepts(BackedIntegerEnum::BAR));
    }
    ...
    public function test_cannot_cast_other_types(): void
    {
        ...
        self::assertFalse($this->backedIntegerEnumType->canCast(404));
    ...
    {
        self::assertSame(PureEnum::class . '::FOO', $this->pureEnumType->toString());
        self::assertSame(BackedStringEnum::class . '::FOO', $this->backedStringEnumType->toString());
        self::assertSame(BackedIntegerEnum::class . '::FOO', $this->backedIntegerEnumType->toString());
    }

    public function test_matches_same_enum_value(): void
    {
        self::assertTrue($this->pureEnumType->matches(new EnumValueType(PureEnum::FOO)));
        self::assertTrue($this->backedStringEnumType->matches(new EnumValueType(BackedStringEnum::FOO)));
        self::assertTrue($this->backedIntegerEnumType->matches(new EnumValueType(BackedIntegerEnum::FOO)));
    }

    public function test_does_not_match_other_enum_value(): void
    {
        self::assertFalse($this->pureEnumType->matches(new EnumValueType(PureEnum::BAR)));
        self::assertFalse($this->backedStringEnumType->matches(new EnumValueType(BackedStringEnum::BAR)));
        self::assertFalse($this->backedIntegerEnumType->matches(new EnumValueType(BackedIntegerEnum::BAR)));
    }
    ...
    public function test_matches_union_type_containing_same_enum(): void
    {
        self::assertTrue($this->pureEnumType->matches(new UnionType(new FakeType(), new EnumValueType(PureEnum::FOO))));
        self::assertTrue($this->backedStringEnumType->matches(new UnionType(new FakeType(), new EnumValueType(BackedStringEnum::FOO))));
        self::assertTrue($this->backedIntegerEnumType->matches(new UnionType(new FakeType(), new EnumValueType(BackedIntegerEnum::FOO))));
    }

    public function test_does_not_match_union_type_not_containing_same_enum(): void
    {
