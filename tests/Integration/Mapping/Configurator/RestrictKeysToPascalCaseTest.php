...
final class RestrictKeysToPascalCaseTest extends IntegrationTestCase
{
    public function test_allows_pascal_case_keys(): void
    {
        $class = new class () {
    ...
    public static function invalid_case_data_provider(): iterable
    {
        ...
        yield 'rejects trailing underscore' => [
            'SomeValue_',
            '[invalid_key_case] Key must follow the PascalCase format.',
        ];
    }
