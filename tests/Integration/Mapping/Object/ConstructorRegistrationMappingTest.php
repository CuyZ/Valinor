...
final class ConstructorRegistrationMappingTest extends IntegrationTestCase
{
    ...
    {
        $this->expectException(ObjectBuildersCollision::class);
        $this->expectExceptionMessage('A type collision was detected between the constructors `CuyZ\Valinor\Tests\Integration\Mapping\Object\constructorA()` and `CuyZ\Valinor\Tests\Integration\Mapping\Object\constructorB()`.');
