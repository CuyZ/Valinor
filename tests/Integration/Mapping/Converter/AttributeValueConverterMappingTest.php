...
final class AttributeValueConverterMappingTest extends IntegrationTestCase
{
    ...
    public function test_can_use_converter_attribute_with_object_parameter_on_callable(): void
    {
        $callable = #[ConverterForCallable(new ObjectHoldingValue(['value' => 'bar']))]
        ...
        self::assertSame('bar', $result['value']);
    }
...
#[Attribute, AsConverter]
final class ConverterForCallable
{
    public function __construct(
        private ObjectHoldingValue $object,
    ) {}
     ...
     */
    public function map(array $value): mixed
    {
